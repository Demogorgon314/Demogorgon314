...
- [streamnative/private-cloud](https://github.com/streamnative/private-cloud) ([sn-operator-v0.13.2](https://github.com/streamnative/private-cloud/releases/tag/sn-operator-v0.13.2), 6 days ago) - StreamNative Private Cloud is an enterprise product which brings specific controllers for Kubernetes by providing specific Custom Resource Definitions (CRDs).
- [apache/pulsar](https://github.com/apache/pulsar) ([v4.1.2](https://github.com/apache/pulsar/releases/tag/v4.1.2), 4 weeks ago) - Apache Pulsar - distributed pub-sub messaging system
...
- [asgeirtj/system_prompts_leaks](https://github.com/asgeirtj/system_prompts_leaks) - Collection of extracted System Prompts from popular chatbots like ChatGPT, Claude &amp; Gemini (7 months ago)
