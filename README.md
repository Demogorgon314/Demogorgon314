...
- [streamnative/oxia-java](https://github.com/streamnative/oxia-java) ([v0.4.7](https://github.com/streamnative/oxia-java/releases/tag/v0.4.7), 2 days ago) - A Java client library for Oxia
- [apache/pulsar](https://github.com/apache/pulsar) ([v3.3.2](https://github.com/apache/pulsar/releases/tag/v3.3.2), 2 weeks ago) - Apache Pulsar - distributed pub-sub messaging system
