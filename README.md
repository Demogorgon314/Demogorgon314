...
- [apache/apisix](https://github.com/apache/apisix) ([2.13.0](https://github.com/apache/apisix/releases/tag/2.13.0), 3 days ago) - The Cloud-Native API Gateway
- [streamnative/kop](https://github.com/streamnative/kop) ([v2.8.2.14](https://github.com/streamnative/kop/releases/tag/v2.8.2.14), 5 days ago) - Kafka-on-Pulsar - A protocol handler that brings native Kafka protocol to Apache Pulsar
...
- [[improve][test] Upgrade awaitility to 4.2.0](https://github.com/apache/pulsar/pull/14859) on [apache/pulsar](https://github.com/apache/pulsar) (2 days ago)
- [Fix offset commit race condition](https://github.com/streamnative/kop/pull/1212) on [streamnative/kop](https://github.com/streamnative/kop) (2 days ago)
- [[cleanup][broker] Remove modular load manager unused variable](https://github.com/apache/pulsar/pull/14832) on [apache/pulsar](https://github.com/apache/pulsar) (3 days ago)
- [[refactor][test] Move assert equals and retry to a base class](https://github.com/apache/pulsar/pull/14815) on [apache/pulsar](https://github.com/apache/pulsar) (4 days ago)
- [[fix][test] Fix wrong retry behavior in MetadataCacheTest](https://github.com/apache/pulsar/pull/14778) on [apache/pulsar](https://github.com/apache/pulsar) (6 days ago)
