...
- [streamnative/kop](https://github.com/streamnative/kop) ([v2.10.1.0-rc2](https://github.com/streamnative/kop/releases/tag/v2.10.1.0-rc2), 2 days ago) - Kafka-on-Pulsar - A protocol handler that brings native Kafka protocol to Apache Pulsar
...
- [apache/pulsar](https://github.com/apache/pulsar) ([v2.9.3](https://github.com/apache/pulsar/releases/tag/v2.9.3), 4 weeks ago) - Apache Pulsar - distributed pub-sub messaging system
...
- [[improve] Check the topic exists from cache](https://github.com/streamnative/kop/pull/1414) on [streamnative/kop](https://github.com/streamnative/kop) (4 weeks ago)
