...
- [streamnative/kop](https://github.com/streamnative/kop) ([v2.11.0.4](https://github.com/streamnative/kop/releases/tag/v2.11.0.4), 2 days ago) - Kafka-on-Pulsar - A protocol handler that brings native Kafka protocol to Apache Pulsar
- [apache/pulsar-client-python](https://github.com/apache/pulsar-client-python) ([v3.1.0](https://github.com/apache/pulsar-client-python/releases/tag/v3.1.0), 2 weeks ago) - Apache Pulsar Python client library
...
- [[improve] Add message.max.bytes for describe broker config](https://github.com/streamnative/kop/pull/1776) on [streamnative/kop](https://github.com/streamnative/kop) (6 days ago)
- [[improve][broker] PIP-192: Support delete namespace bundle admin API](https://github.com/apache/pulsar/pull/19851) on [apache/pulsar](https://github.com/apache/pulsar) (1 week ago)
- [[improve][broker] PIP-192: Make split admin API functional](https://github.com/apache/pulsar/pull/19773) on [apache/pulsar](https://github.com/apache/pulsar) (2 weeks ago)
...
- [datasone/grub-mod-setup_var](https://github.com/datasone/grub-mod-setup_var) - A modified grub allowing tweaking hidden BIOS settings. (4 weeks ago)
- [LongSoft/UEFITool](https://github.com/LongSoft/UEFITool) - UEFI firmware image viewer and editor (4 weeks ago)
