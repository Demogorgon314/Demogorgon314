...
- [apache/pulsar](https://github.com/apache/pulsar) ([v4.1.2](https://github.com/apache/pulsar/releases/tag/v4.1.2), 2 days ago) - Apache Pulsar - distributed pub-sub messaging system
- [streamnative/private-cloud](https://github.com/streamnative/private-cloud) ([sn-operator-v0.12.18](https://github.com/streamnative/private-cloud/releases/tag/sn-operator-v0.12.18), 6 days ago) - StreamNative Private Cloud is an enterprise product which brings specific controllers for Kubernetes by providing specific Custom Resource Definitions (CRDs).
