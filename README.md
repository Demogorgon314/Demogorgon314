...
- [streamnative/kop](https://github.com/streamnative/kop) ([v2.7.4.2](https://github.com/streamnative/kop/releases/tag/v2.7.4.2), 2 days ago) - Kafka-on-Pulsar - A protocol handler that brings native Kafka protocol to Apache Pulsar
...
- [[cleanup][broker]: avoid using hard code strings in `NamespaceEventsSystemTopicFactory`](https://github.com/apache/pulsar/pull/14731) on [apache/pulsar](https://github.com/apache/pulsar) (2 days ago)
- [Bump pulsar to 2.9.2.8 and fix test list offset for empty rollover ledger](https://github.com/streamnative/kop/pull/1179) on [streamnative/kop](https://github.com/streamnative/kop) (4 days ago)
- [Fix message disorder issue](https://github.com/streamnative/kop/pull/1174) on [streamnative/kop](https://github.com/streamnative/kop) (6 days ago)
