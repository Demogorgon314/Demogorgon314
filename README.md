...
- [apache/pulsar](https://github.com/apache/pulsar) ([v2.7.5](https://github.com/apache/pulsar/releases/tag/v2.7.5), 2 days ago) - Apache Pulsar - distributed pub-sub messaging system
- [streamnative/kop](https://github.com/streamnative/kop) ([v2.9.3.7](https://github.com/streamnative/kop/releases/tag/v2.9.3.7), 5 days ago) - Kafka-on-Pulsar - A protocol handler that brings native Kafka protocol to Apache Pulsar
...
- [NJU-ProjectN/abstract-machine](https://github.com/NJU-ProjectN/abstract-machine) - A minimal, modularized, and machine-independent hardware abstraction layer (2 days ago)
- [alesimula/wsa_pacman](https://github.com/alesimula/wsa_pacman) - A GUI package manager and package installer for Windows Subsystem for Android (WSA) (5 days ago)
