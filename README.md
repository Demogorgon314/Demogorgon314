...
- [apache/pulsar](https://github.com/apache/pulsar) ([v2.8.4](https://github.com/apache/pulsar/releases/tag/v2.8.4), 2 days ago) - Apache Pulsar - distributed pub-sub messaging system
- [streamnative/kop](https://github.com/streamnative/kop) ([v2.9.3.12](https://github.com/streamnative/kop/releases/tag/v2.9.3.12), 5 days ago) - Kafka-on-Pulsar - A protocol handler that brings native Kafka protocol to Apache Pulsar
