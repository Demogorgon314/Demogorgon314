...
- [streamnative/oxia-java](https://github.com/streamnative/oxia-java) ([v0.4.6](https://github.com/streamnative/oxia-java/releases/tag/v0.4.6), 1 week ago) - A Java client library for Oxia
- [apache/pulsar](https://github.com/apache/pulsar) ([v3.3.2](https://github.com/apache/pulsar/releases/tag/v3.3.2), 1 week ago) - Apache Pulsar - distributed pub-sub messaging system
- [streamnative/private-cloud](https://github.com/streamnative/private-cloud) ([sn-operator-v0.2.2](https://github.com/streamnative/private-cloud/releases/tag/sn-operator-v0.2.2), 2 weeks ago) - StreamNative Private Cloud is an enterprise product which brings specific controllers for Kubernetes by providing specific Custom Resource Definitions (CRDs).

#### 🔨 My recent Pull Requests

- [[fix][test] Fix ReplicatorRateLimiterTest](https://github.com/apache/pulsar/pull/23369) on [apache/pulsar](https://github.com/apache/pulsar) (2 weeks ago)
- [[fix][ml] Managed ledger should recover after open ledger failed](https://github.com/apache/pulsar/pull/23368) on [apache/pulsar](https://github.com/apache/pulsar) (2 weeks ago)
...
- [vosen/ZLUDA](https://github.com/vosen/ZLUDA) - CUDA on non-NVIDIA GPUs (7 months ago)
