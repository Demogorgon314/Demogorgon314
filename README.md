...
- [streamnative/kop](https://github.com/streamnative/kop) ([v2.11.0.5](https://github.com/streamnative/kop/releases/tag/v2.11.0.5), 3 days ago) - Kafka-on-Pulsar - A protocol handler that brings native Kafka protocol to Apache Pulsar
- [apache/pulsar-client-go](https://github.com/apache/pulsar-client-go) ([v0.10.0](https://github.com/apache/pulsar-client-go/releases/tag/v0.10.0), 6 days ago) - Apache Pulsar Go Client Library
...
- [[test] Add kafka admin api unit test](https://github.com/streamnative/kop/pull/1793) on [streamnative/kop](https://github.com/streamnative/kop) (2 days ago)
- [[improve][broker] PIP-192: Update the lookup data path to support deploy and rollback](https://github.com/apache/pulsar/pull/19999) on [apache/pulsar](https://github.com/apache/pulsar) (6 days ago)
