...
- [streamnative/kop](https://github.com/streamnative/kop) ([v2.8.3.3](https://github.com/streamnative/kop/releases/tag/v2.8.3.3), 2 days ago) - Kafka-on-Pulsar - A protocol handler that brings native Kafka protocol to Apache Pulsar
- [apache/apisix](https://github.com/apache/apisix) ([2.14.0](https://github.com/apache/apisix/releases/tag/2.14.0), 3 days ago) - The Cloud-Native API Gateway
...
- [[fix][admin] Unwrap the completion exception on schemas admin API](https://github.com/apache/pulsar/pull/15733) on [apache/pulsar](https://github.com/apache/pulsar) (1 day ago)
- [[fix][schema] Fix update schema forward compatibility strategy behavior](https://github.com/apache/pulsar/pull/15718) on [apache/pulsar](https://github.com/apache/pulsar) (2 days ago)
- [[fix][doc] Fix security-oauth2 docs curl example OAuth URL](https://github.com/apache/pulsar/pull/15708) on [apache/pulsar](https://github.com/apache/pulsar) (2 days ago)
