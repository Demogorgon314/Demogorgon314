...
- [streamnative/kop](https://github.com/streamnative/kop) ([v2.8.3.3](https://github.com/streamnative/kop/releases/tag/v2.8.3.3), 3 days ago) - Kafka-on-Pulsar - A protocol handler that brings native Kafka protocol to Apache Pulsar
- [apache/apisix](https://github.com/apache/apisix) ([2.14.0](https://github.com/apache/apisix/releases/tag/2.14.0), 4 days ago) - The Cloud-Native API Gateway
...
- [[Improve][doc] Add config of NAR extraction directory for the broker configuration](https://github.com/apache/pulsar/pull/15778) on [apache/pulsar](https://github.com/apache/pulsar) (1 day ago)
- [[fix][admin] Unwrap the completion exception on schemas admin API](https://github.com/apache/pulsar/pull/15733) on [apache/pulsar](https://github.com/apache/pulsar) (2 days ago)
- [[fix][schema] Fix update schema forward compatibility strategy behavior](https://github.com/apache/pulsar/pull/15718) on [apache/pulsar](https://github.com/apache/pulsar) (3 days ago)
- [[fix][doc] Fix security-oauth2 docs curl example OAuth URL](https://github.com/apache/pulsar/pull/15708) on [apache/pulsar](https://github.com/apache/pulsar) (3 days ago)
...
- [[bugfix][flaky-test] Fix handle produce request npe](https://github.com/streamnative/kop/pull/1271) on [streamnative/kop](https://github.com/streamnative/kop) (2 weeks ago)
- [[transaction] Support write transaction marker when using oauth2 authentication](https://github.com/streamnative/kop/pull/1268) on [streamnative/kop](https://github.com/streamnative/kop) (3 weeks ago)
...
- [javahuang/SurveyKing](https://github.com/javahuang/SurveyKing) - Make a better open source survey system. (3 weeks ago)
