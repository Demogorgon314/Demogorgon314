...
- [streamnative/kop](https://github.com/streamnative/kop) ([v2.10.4.5](https://github.com/streamnative/kop/releases/tag/v2.10.4.5), 5 days ago) - Kafka-on-Pulsar - A protocol handler that brings native Kafka protocol to Apache Pulsar
...
- [[branch-2.10.4][improve] Pass group ID to authorizer when using OAuth (#1926)](https://github.com/streamnative/kop/pull/1945) on [streamnative/kop](https://github.com/streamnative/kop) (5 days ago)
