...
- [streamnative/kop](https://github.com/streamnative/kop) ([v3.0.0.2-SNAPSHOT](https://github.com/streamnative/kop/releases/tag/v3.0.0.2-SNAPSHOT), 1 day ago) - Kafka-on-Pulsar - A protocol handler that brings native Kafka protocol to Apache Pulsar
- [apache/pulsar-client-python](https://github.com/apache/pulsar-client-python) ([v3.1.0](https://github.com/apache/pulsar-client-python/releases/tag/v3.1.0), 3 days ago) - Apache Pulsar Python client library
