...
- [streamnative/kop](https://github.com/streamnative/kop) ([v2.7.4.8](https://github.com/streamnative/kop/releases/tag/v2.7.4.8), 1 day ago) - Kafka-on-Pulsar - A protocol handler that brings native Kafka protocol to Apache Pulsar
...
- [[CI] Cancel previous CI workflow if new commit pushed](https://github.com/streamnative/kop/pull/1425) on [streamnative/kop](https://github.com/streamnative/kop) (6 days ago)
